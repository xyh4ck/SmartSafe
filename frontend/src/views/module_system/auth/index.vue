<template>
  ...
  >
    ...
    <div flex-1 flex-center>
      <div
        class="p-4xl w-full h-auto sm:w-450px border-rd-10px sm:h-640px bg-white/30 dark:bg-black/55 border border-white/25 shadow-[0_12px_40px_rgba(0,0,0,0.35)] backdrop-blur-3px"
      >
