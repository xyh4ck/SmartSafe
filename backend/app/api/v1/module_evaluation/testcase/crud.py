...
from app.api.v1.module_evaluation.testcase.schema import TestCaseCreateSchema, TestCaseUpdateSchema


class TestCaseCRUD(CRUDBase[TestCaseModel, TestCaseCreateSchema, TestCaseUpdateSchema]):
    ...
    async def create_crud(self, data: TestCaseCreateSchema):
        return await self.create(data=data)

    async def update_crud(self, id: int, data: TestCaseUpdateSchema):
